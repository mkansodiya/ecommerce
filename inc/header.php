                        ...
                        <div class="header-left">
                            <div class="sm-nav-block">
                                ...
                                <ul class="nav-slide">
                                    ...
                                    <li><a href="category-page(left-sidebar).php">western ware</a></li>
                                    <li><a href="category-page(left-sidebar).php">TV, Appliances</a></li>
                                    <li><a href="category-page(left-sidebar).php">Pets Products</a></li>
                                    <li><a href="category-page(left-sidebar).php">Car, Motorbike</a></li>
                                    <li><a href="category-page(left-sidebar).php">Industrial Products</a></li>
                                    <li><a href="category-page(left-sidebar).php">Beauty, Health Products</a></li>
                                    <li><a href="category-page(left-sidebar).php">Grocery Products </a></li>
                                    <li><a href="category-page(left-sidebar).php">Sports</a></li>
                                    <li><a href="category-page(left-sidebar).php">Bags, Luggage</a></li>
                                    <li><a href="category-page(left-sidebar).php">Movies, Music </a></li>
                                    <li><a href="category-page(left-sidebar).php">Video Games</a></li>
                                    <li><a href="category-page(left-sidebar).php">Toys, Baby Products</a></li>
                               ...
                               M451.001,482H451H61v-71.363C96.031,360.683,152.952,331,214.167,331h83.667c61.215,0,118.135,29.683,153.167,79.637V482z" />
                                    ...
                                    <li class="mobile-wishlist item-count" onclick="openWishlist()">
                                        <a href="javascript:void(0)">
                                            ...
                                            <div id="wishlist1" class="item-count-contain">
                                                0
                                            </div>
                                        </a>
                                    </li>
                                    <li class="mobile-cart item-count" onclick="openCart()">
                                        ...
                                        <div id="cart_count1" class="item-count-contain">
                                            <?php echo $cart_count; ?>
                                        </div>
                                    </li>
                                </ul>
                    ...
                    <div class="col-12">
                        <div class="navbar-menu">
                                ...
                                <div class="nav-left">
                                    ...
                                    <div class="collapse  nav-desk" id="navbarToggleExternalContent">
                                        <ul class="nav-cat title-font">
                                            <li> <a href="category-page(left-sidebar).php"><img src="./assets/images/layout-1/nav-img/01.png" alt="category-product"> western ware</a></li>
                                            <li> <a href="category-page(left-sidebar).php"><img src="./assets/images/layout-1/nav-img/02.png" alt="category-product"> TV, Appliances</a></li>
                                            <li> <a href="category-page(left-sidebar).php"><img src="assets/images/layout-1/nav-img/03.png" alt="category-product"> Pets Products</a></li>
                                            <li> <a href="category-page(left-sidebar).php"><img src="assets/images/layout-1/nav-img/04.png" alt="category-product"> Car, Motorbike</a></li>
                                            <li> <a href="category-page(left-sidebar).php"><img src="assets/images/layout-1/nav-img/05.png" alt="category-product"> Industrial Products</a></li>
                                            <li> <a href="category-page(left-sidebar).php"><img src="assets/images/layout-1/nav-img/06.png" alt="category-product"> Beauty, Health Products</a></li>
                                            <li> <a href="category-page(left-sidebar).php"><img src="assets/images/layout-1/nav-img/07.png" alt="category-product"> Grocery Products </a></li>
                                            <li> <a href="category-page(left-sidebar).php"><img src="assets/images/layout-1/nav-img/08.png" alt="category-product"> Sports</a></li>
                                            <li> <a href="category-page(left-sidebar).php"><img src="assets/images/layout-1/nav-img/09.png" alt="category-product"> Bags, Luggage</a></li>
                                            <li> <a href="category-page(left-sidebar).php"><img src="assets/images/layout-1/nav-img/10.png" alt="category-product"> Movies, Music </a></li>
                                            <li> <a href="category-page(left-sidebar).php"><img src="assets/images/layout-1/nav-img/11.png" alt="category-product"> Video Games</a></li>
                                            <li> <a href="category-page(left-sidebar).php"><img src="assets/images/layout-1/nav-img/12.png" alt="category-product"> Toys, Baby Products</a></li>
                                            <li>
                                ...
                                <nav id="main-nav">
                                    ...
                                    <ul id="main-menu" class="sm pixelstrap sm-horizontal">
                                        ...
                                        <li>
                                            ...
                                            <ul>
                                                <li><a href="index.php">mega store 1</a></li>
                                                <li><a href="layout-2.php">mega store 2</a></li>
                                                <li><a href="layout-3.php">mega store 3</a></li>
                                                <li><a href="layout-4.php">mega store 4</a></li>
                                                <li><a href="megastore.php">mega store 5</a></li>
                                                <li><a href="layout-5.php">electronics</a></li>
                                                <li><a href="layout-6.php">vegetable</a></li>
                                                ...
                                                <li><a href="digital-marketplace.php">digital marketplace</a></li>
                                            </ul>
                                        </li>
                                        <!--HOME-END-->
                                        <!--SHOP-->
                                        <li>
                                            ...
                                            <ul>
                                                <li><a href="category-page(left-sidebar).php">left sidebar</a></li>
                                                <li><a href="category-page(right-sidebar).php">right sidebar</a></li>
                                                ...
                                                <li><a href=category-page(3-grid).php>3 grid</a></li>
                                                <li><a href="category-page(6-grid).php">6 grid</a></li>
                                                        ...
                                                        <div class="row">
                                                            <div class="col mega-box">
                                                                <div class="link-section">
                                                                    ...
                                                                    <div class="menu-content">
                                                                        <ul>
                                                                            <li><a href="product-page(left-sidebar).php">left sidebar</a></li>
                                                                            <li><a href="product-page(right-sidebar).php">right sidebar</a></li>
                                                                            <li><a href="product-page(no-sidebar).php">non sidebar</a></li>
                                                                        </ul>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="link-section">
                                                                    ...
                                                                    <div class="menu-content">
                                                                        <ul>
                                                                            ...
                                                                            <li><a href="product-page(video-thumbnail).php">video thumbnail</a></li>
                                                                        </ul>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col mega-box">
                                                                <div class="link-section">
                                                                    ...
                                                                    <div class="menu-content">
                                                                        <ul>
                                                                            <li><a href="product-page(4-image).php">4 image </a></li>
                                                                            <li><a href="product-page(sticky).php">sticky</a></li>
                                                                            <li><a href="product-page(accordian).php">accordian</a></li>
                                                                            <li><a href="product-page(360-view).php">360 view</a></li>
                                                                        </ul>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col mega-box">
                                                                <div class="link-section">
                                                                    ...
                                                                    <div class="menu-content">
                                                                        <ul>
                                                                            <li><a href="product-page(3-col-left).php">thumbnail left</a></li>
                                                                            <li><a href="product-page(3-col-right).php">thumbnail right</a></li>
                                                                            <li><a href="product-page(3-column).php">thubnail bottom</a></li>
                                                                        </ul>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="row">
                                                                ...
                                                                <div class="link-section">
                                                                    ...
                                                                    <div class="menu-content">
                                                                        <ul>
                                                                            ...
                                                                            <li><a href="grid-6-col.php">portfolio grid 6</a></li>
                                                                            <li><a href="masonary-2-grid.php">mesonary grid 2</a></li>
                                                                            <li><a href="masonary-3-grid.php">mesonary grid 3</a></li>
                                                                            <li><a href="masonary-4-grid.php">mesonary grid 4</a></li>
                                                                            <li><a href="masonary-fullwidth.php">mesonary full width</a></li>
                                                                        </ul>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col mega-box">
                                                                <div class="link-section">
                                                                    ...
                                                                    <div class="menu-content">
                                                                        <ul>
                                                                            <li><a href="layout-5.php">cart modal popup</a></li>
                                                                            <li><a href="layout-6.php">qty. counter </a></li>
                                                                            <li><a href="index.php">cart top</a></li>
                                                                            <li><a href="layout-2.php">cart bottom</a></li>
                                                                            <li><a href="layout-3.php">cart left</a></li>
                                                                            <li><a href="layout-4.php">cart right</a></li>
                                                                        </ul>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="link-section">
                                                                    ...
                                                                    <div class="menu-content">
                                                                        <ul>
                                                                            ...
                                                                            <li><a href="element-image-ratio.php">image size ratio</a></li>
                                                                            <li><a href="element-tab.php">tab</a></li>
                                                                            <li><a href="element-counter.php">counter</a></li>
                                                                            <li><a href="element-pricingtable.php">pricing table</a></li>
                                                                            <li><a href="element-team.php">team</a></li>
                                                                            <li><a href="element-testimonial.php">testimonial</a></li>
                                                                        </ul>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            <div class="col mega-box">
                                                                <div class="link-section">
                                                                    ...
                                                                    <div class="menu-content">
                                                                        <ul>
                                                                            <li><a href="email-template/email-order-success.php">order success</a></li>
                                                                            <li><a href="email-template/email-order-success-tow.php">order success 2</a></li>
                                                                            <li><a href="../email-template/email-template.php">email template</a></li>
                                                                            <li><a href="../email-template/email-template-tow.php">email template 2</a></li>
                                                                        </ul>
                                                                    </div>
                                                                    ...
                                                                    <div class="menu-content">
                                                                        <ul>
                                                                            <li><a href="button.php">element button</a></li>
                                                                            <li><a href="instagram.php">element instagram</a></li>
                                                                        </ul>
                                                                    </div>
                                                                </div>
                                                            </div>
                                        ...
                                        <li>
                                            ...
                                            <ul>
                                                <li>
                                                    ...
                                                    <ul>
                                                        <li><a href="../invoice-template/element-invoice.php">invoice one</a></li>
                                                        <li><a href="../invoice-template/element-invoice2.php">invoice two</a></li>
                                                        <li><a href="../invoice-template/element-invoice3.php">invoice three</a></li>
                                                        <li><a href="../invoice-template/element-invoice4.php">invoice four</a></li>
                                                        <li><a href="../invoice-template/element-invoice5.php">invoice five</a></li>
                                                    </ul>
                                                </li>
                                                <li>
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li><a href="forget-pwd.php">forget password</a></li>
                                                        <li><a href="profile.php">profile </a></li>
                                                        <li>
                                                            <a href="javascript:void(0)">checkout</a>
                                                            <ul>
                                                                <li><a href="checkout.php">checkout 1</a></li>
                                                                <li><a href="checkout2.php">checkout 2<span class="new-tag">new</span></a></li>
                                                            </ul>
                                                        </li>
                                                    </ul>
                                                </li>
                                                ...
                                                <li><a href="look-book.php">lookbook</a></li>
                                        ...
                                        <li>
                                            ...
                                            <ul>
                                                ...
                                                <li><a href="blog-creative(left-sidebar).php">creative left sidebar</a></li>
                                            </ul>
                                        </li>
                                        <!--blog-meu end-->
                                    </ul>
                            ...
                            S377.82,467.8,257.493,467.8z" />
                                    ...
                                    <li class="mobile-user onhover-dropdown" <?php $action = "";
                             ...
                             M451.001,482H451H61v-71.363C96.031,360.683,152.952,331,214.167,331h83.667c61.215,0,118.135,29.683,153.167,79.637V482z" />
                                    ...
                                    <li class="mobile-wishlist item-count" onclick="openWishlist()">
                                        <a href="javascript:void(0)">
                                            ...
                                            <div id="wishlist" class="item-count-contain">
                                                0
                                            </div>
                                        </a>
                                    </li>
                                    <li class="mobile-cart item-count" onclick="openCart()">
                                        ...
                                        <div id="cart_count" class="item-count-contain">
                                            <?php echo $cart_count; ?>
                                        </div>
                                    </li>
                                </ul>
