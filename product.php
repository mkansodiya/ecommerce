...
$p = getProductByID($_GET['id']);
$p_arr = mysqli_fetch_assoc($p);
$offer =  ((($p_arr['mrp']) - ($p_arr['selling_price'])) / ($p_arr['mrp'])) * 100;
                            ...
                            <div class="collection-collapse-block-content">
                                <div class="collection-brand-filter">
                                    <ul class="category-list">
                                        <?php $cat_query = getCategories();
                                        $cat = array();
                                        while ($cat_data = mysqli_fetch_assoc($cat_query)) {

                                        ?>
                                            <li><a href="javascript:void(0)">
                                                    <?php echo $cat_data['cat_title']; ?>
                                                </a></li>
                                        <?php } ?>
                                    </ul>
                                </div>
                        ...
                        <div class="slide-1">
                            <div>
                                <div class="media-banner plrb-0 b-g-white1 border-0">
                                    <?php
                                    $p_data1 = getProducts(3);
                                    while ($p_arr1 = mysqli_fetch_assoc($p_data1)) {
                                        $product1[] = $p_arr1;
                                    }
                                    foreach ($product1 as $key1) {
                                    ?>
                                        <div class="media-banner-box">
                                            <div class="media">
                                                <a href="product-page(left-sidebar).php" tabindex="0">
                                                    <img src="<?php echo 'assets/images/products/' . $key1['product_image']; ?>" class=" img-fluid " alt=" banner">
                                                </a>
                                                <div class="media-body">
                                                    <div class="media-contant">
                                                        <div>
                                                            <div class="product-detail">
                                                                ...
                                                                <a href="<?php echo 'product.php?id=' . $key1['product_id']; ?>" tabindex="0">
                                                                    <p><?php echo $key1['product_name']; ?></p>
                                                                </a>
                                                                <h6><?php echo $key1['selling_price']; ?> <span><?php echo $key1['mrp']; ?></span></h6>
                                                            </div>
                                                            <div class="cart-info">
                                                                ...
                                                                <a href="javascript:void(0)" onclick="getProduct(<?php echo $key['product_id'] ?>,4,'editCart');" data-bs-toggle="modal" data-bs-target="#quick-view" class="tooltip-top" data-tippy-content="Quick View"><i data-feather="eye"></i></a>
                                                                <a href="compare.php" class="tooltip-top" data-tippy-content="Compare"><i data-feather="refresh-cw"></i></a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                        ...
                        <div class="row ">
                            <div class="col-lg-5">
                                <div class="product-slick ">
                                    <div><img src="<?php echo "assets/images/products/" . $p_arr['product_image']; ?>" alt="" class="img-fluid  image_zoom_cls-0"></div>
                                    <div><img src="<?php echo "assets/images/products/" . $p_arr['product_image']; ?>" alt="" class="img-fluid  image_zoom_cls-1"></div>
                                    <div><img src="<?php echo "assets/images/products/" . $p_arr['product_image']; ?>" alt="" class="img-fluid  image_zoom_cls-2"></div>
                                    <div><img src="<?php echo "assets/images/products/" . $p_arr['product_image']; ?>" alt="" class="img-fluid  image_zoom_cls-3"></div>
                                </div>
                                <div class="row">
                                    <div class="col-12 p-0">
                                        <div class="slider-nav">
                                            <div><img src="<?php echo "assets/images/products/" . $p_arr['product_image']; ?>" alt="" class="img-fluid"></div>
                                            <div><img src="<?php echo "assets/images/products/" . $p_arr['product_image']; ?>" alt="" class="img-fluid"></div>
                                            <div><img src="<?php echo "assets/images/products/" . $p_arr['product_image']; ?>" alt="" class="img-fluid"></div>
                                            <div><img src="<?php echo "assets/images/products/" . $p_arr['product_image']; ?>" alt="" class="img-fluid"></div>
                                        </div>
                            ...
                            <div class="col-lg-7 rtl-text">
                                <div class="product-right ">
                                    <div class="pro-group">
                                        <h2 class="page_title"><?php echo $p_arr['product_name']; ?></h2>
                                        <ul class="pro-price">
                                            <li><?php echo $p_arr['selling_price']; ?></li>
                                            <li><span><?php echo $p_arr['mrp']; ?></span></li>
                                            <li><?php echo round($offer, 0) . "% OFF"; ?></li>
                                        </ul>
                                        <div class="revieu-box">
                                            ...
                                            <a href="review.php"><span>(6 reviews)</span></a>
                                        </div>
                                    ...
                                    <div id="selectSize" class="pro-group addeffect-section product-description border-product">
                                        ...
                                        <div class="qty-box">
                                            <div class="input-group">
                                                ...
                                                <input id="cart_qty" class="qty-adj form-control" type="number" value="1" />
                                                <button class="qty-plus"></button>

                                            </div>

                                        </div>
                                        <div onclick="manageCart(<?php echo  $_GET['id']; ?>,$('#cart_qty').val(),'add')" class="product-buttons">
                            ...
                            <div class="col-sm-12 col-lg-12">
                                ...
                                <div class="tab-content nav-material" id="top-tabContent">
                                    <div class="tab-pane fade show active" id="top-home" role="tabpanel" aria-labelledby="top-home-tab">
                                        <p><?php echo $p_arr['description']; ?></p>
                                    </div>
        ...
        <div class="row">
            <div class="col-12 product">
                <div class="product-slide-6 product-m no-arrow">
                    <?php
                    $p_data = getProducts(5);
                    while ($p_arr = mysqli_fetch_assoc($p_data)) {
                        $product[] = $p_arr;
                    }
                                ...
                                <div class="product-imgbox">
                                    <div class="product-front">
                                        <a href="<?php echo  "product.php?id=" . $key["product_id"]; ?>">
                                            <img src="<?php echo "assets/images/products/" . $key['product_image'] ?>" class="img-fluid  " alt="product">
                                        </a>
                                    </div>
                                    ...
                                    <div class="product-icon icon-inline">
                                        <button onclick="manageCart(<?php echo  $key['product_id']; ?>,1,'add')" class="tooltip-top" data-bs-toggle="modal" data-bs-target="#addtocart" class="tooltip-top" data-tippy-content="Add to cart">
                                            <i data-feather="shopping-cart"></i>
                                        </button>
                                        <a href="javascript:void(0)" class="add-to-wish tooltip-top" data-tippy-content="Add to Wishlist">
                                            <i data-feather="heart"></i>
                                        </a>
                                        <a href="javascript:void(0)" onclick="getProduct(<?php echo $key['product_id'] ?>,4,'editCart');" data-bs-toggle="modal" data-bs-target="#quick-view" class="tooltip-top" data-tippy-content="Quick View">
                                            <i data-feather="eye"></i>
                                        </a>
                                        <a href="compare.php" class="tooltip-top" data-tippy-content="Compare">
            ...
            <div class="modal-body">
                ...
                <div class="pro-group">
                    <div class="product-img">
                        <div class="media">
                            ...
                            <div class="media-body">
                                <a href="<?php echo  "product.php?id=" . $key["product_id"]; ?>">
                                    <h3 id="cartProductTitle">redmi not 3</h3>
                                </a>
                                <h6 id="sellingPrice">$80<span id="mrp">$120</span></h6>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="pro-group">
                    ...
                    <div class="qty-box">
                        <div class="input-group">
                            <button class="qty-minus"></button>
                            <input id="cart_q" class="qty-adj form-control" type="number" value="1" />
                            <button class="qty-plus"></button>
                        </div>

                    </div>
                    <input id="p_id" class="qty-adj form-control" type="number" value="1" style="display:none" />
                </div>
                <div class="pro-group mb-0">
                    <div class="modal-btn">
                        <a onclick="manageCart($('#p_id').val(),$('#cart_q').val(),'update')" href="" class="btn btn-solid btn-sm">
                            update cart
                        </a>
                        <a href="<?php echo  "product.php?id=" . $key["product_id"]; ?>" class="btn btn-solid btn-sm">
                            more detail
                        </a>
                    </div>
                </div>
...
<!-- Add to cart bar -->
<?php include("inc/cart_slide_right.php"); ?>
<!-- Add to cart bar end-->
    ...
    <div class="cart-inner">
        ...
        <div class="cart_media">
            <ul class="cart_product">
                <li>
                    <div class="media">
                        ...
                        <div class="media-body">
                            <a href="product-page(left-sidebar).php">
                                <h4 id="productName">redmi not 3</h4>
                            </a>
                            <h6>
            ...
            <ul class="cart_total">
                ...
                <li>
                    <div class="buttons">
                        <a href="wishlist.php" class="btn btn-solid btn-block btn-md">view wislist</a>
                    </div>
                </li>
            </ul>
        </div>
...
<?php include("inc/login_sidebar.php"); ?>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="modal-bg addtocart">
                                ...
                                <div class="media">
                                    <a href="javascript:void(0)">
                                        <img id="cartAddedImage" src="assets/images/layout-4/product/3.jpg" alt="cart-image" class="img-fluids">
                                    </a>
                                    <div class="media-body align-self-center text-center">
                                        <a href="javascript:void(0)">
                                            <h6>
                                                <i class="fa fa-check"></i>Item
                                                <span id="cartAddedNote">men full sleeves</span>
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-lg-6 col-xs-12">
                        <div class="quick-view-img bg-size" id="quickViewImg1" style="background-image: url(' assets/images/layout-1/product/3.jpg'); background-size: cover; background-position: center center; display: block;">
                            <img id="quickViewImg" src="assets/images/layout-1/product/3.jpg" alt="" class="img-fluid bg-img">
                        </div>
                    </div>
                    <div class="col-lg-6 rtl-text">
                        <div class="product-right">
                            <div class="pro-group">
                                <h2 id="quickViewTitle">
                                    Double Door Refrigerator
                                </h2>
                                <ul class="pro-price">
                                    <li id="quickViewSp">$70</li>
                                    <li id="quickViewMrp"><span>mrp $140</span></li>
                                    <li>50% off</li>
                                </ul>
                                <div class="revieu-box">
                                    <ul>
                            ...
                            <div class="pro-group pb-0">
                                ...
                                <div class="product-buttons">
                                    <a href="javascript:void(0)" onclick="manageCart(167,7,'add')" class="btn cart-btn btn-normal tooltip-top" data-tippy-content="Add to cart">
                                        <i class="fa fa-shopping-cart"></i>
                                        add to cart
                                    </a>
                                    <a href="product-page(left-sidebar).php" class="btn btn-normal tooltip-top" data-tippy-content="view detail">
                                        view detail
                                    </a>
                                </div>
                            </div>
    ...
    <div class="container">
        <div class="cart-content">
            <div class="product-image">
                <img src="<?php $p = getProductByID($_GET['id']);
                            $p_arr = mysqli_fetch_assoc($p);
                            echo "assets/images/products/" . $p_arr['product_image']; ?>" class="img-fluid" alt="">
                <div class="content d-lg-block d-none">
                    <h5><?php echo ($p_arr)['product_name'];  ?></h5>
                    <h6><?php echo $p_arr['selling_price']; ?><del><?php echo $p_arr['mrp']; ?></del><span><?php echo round($offer, 0) . "% OFF"; ?></span></h6>
                </div>
            </div>
            ...
            <div class="add-btn">
                <a href="javascript:void(0)" onclick="manageCart(<?php echo  $_GET['id']; ?>,$('#cart_qty').val(),'add')" class="btn btn-solid btn-sm">add to cart</a>
            </div>
        </div>
    </div>
</div>
...
<div class="added-notification ">
    <img src="<?php echo "assets/images/products/" . $p_arr['product_image'] ?>" class="img-fluid" alt="">
    <h3>added to cart</h3>
</div>
<!-- added to cart notification -->
