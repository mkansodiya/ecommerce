        ...
        <div class="row">
            <div class="col-xl-4 col-lg-6 col-md-8 offset-xl-4 offset-lg-3 offset-md-2">
                <div class="theme-card">
                    ...
                    <form id="login_form" class="theme-form">
                        ...
                        <a href="javascript:void(0)" id="login_button" onclick="manageUser('login')" class="btn btn-normal">Login</a>
                        <a class="float-middle txt-default mt-2" id="response" href="forget-pwd.html"></a>
