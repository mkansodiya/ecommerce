        ...
        <div class="card btn-months">
          <div class="card-header">
            ...
            <div class="dashboard-btn-groups">
              <div class="btn-group" role="group" aria-label="Basic example">
                <button class="btn btn-outline-light btn-js" type="button">
                  Day
                </button>
                <button class="btn btn-outline-light btn-js" type="button">
                  Week
                </button>
                <button class="btn btn-outline-light btn-js active" type="button">
                  Month
                </button>
              </div>
            </div>
          ...
          <div class="card-body">
            ...
            <div class="code-box-copy">
              <button class="code-box-copy__btn btn-clipboard" data-clipboard-target="#example-head8" title="" data-original-title="Copy">
        ...
        <div class="card">
          <div class="card-header">
            ...
            <div class="chart-value-box pull-right">
              ...
              <div class="value-square-box-secondary ms-3"></div>
      ...
      <div class="col-xl-6 xl-100">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <div class="code-box-copy">
              <button class="code-box-copy__btn btn-clipboard" data-clipboard-target="#example-head1" title="" data-original-title="Copy">
                <i class="icofont icofont-copy-alt"></i>
              </button>
      ...
      <div class="col-sm-12">
        <div class="card btn-months">
          <div class="card-header">
            ...
            <div class="dashboard-btn-groups">
              <div class="btn-group" role="group" aria-label="Basic example">
                <button class="btn btn-outline-light btn-js1" type="button">
                  Day
                </button>
                <button class="btn btn-outline-light btn-js1" type="button">
                  Week
          ...
          <div class="card-body sell-graph">
            ...
            <div class="code-box-copy">
              <button class="code-box-copy__btn btn-clipboard" data-clipboard-target="#example-head3" title="" data-original-title="Copy">
                <i class="icofont icofont-copy-alt"></i>
              </button>
      ...
      <div class="col-xl-4 xl-50">
        <div class="card customers-card">
          ...
          <div class="card-body p-0">
            ...
            <div class="code-box-copy">
              <button class="code-box-copy__btn btn-clipboard" data-clipboard-target="#example-head7" title="" data-original-title="Copy">
                <i class="icofont icofont-copy-alt"></i>
              </button>
      ...
      <div class="col-xl-8 xl-50">
        <div class="card height-equal">
          ...
          <div class="card-body">
                    ...
                    <td class="bd-t-none u-s-tb">
                      <div class="align-middle image-sm-size">
                        <img class="
                                    ...
                                    blur-up
                                    lazyloaded
                                  " src="../assets/images/dashboard/man.png" alt="" data-original-title="" title="" />
                        <div class="d-inline-block">
                          <h6>
                            Mohsib lara<span class="text-muted digits">(99+ Online)</span>
                          </h6>
                        </div>
                      </div>
                    </td>
                    ...
                    <td class="bd-t-none u-s-tb">
                      <div class="align-middle image-sm-size">
                        <img class="
                                    ...
                                    blur-up
                                    lazyloaded
                                  " src="../assets/images/dashboard/designer.jpg" alt="" data-original-title="" title="" />
                        <div class="d-inline-block">
                          <h6>
                            Pusiz bia
                            <span class="text-muted digits">(14+ Online)</span>
            ...
            <div class="code-box-copy">
              <button class="code-box-copy__btn btn-clipboard" data-clipboard-target="#example-head5" title="" data-original-title="Copy">
                <i class="icofont icofont-copy-alt"></i>
              </button>
      ...
      <div class="col-sm-12">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <div class="code-box-copy">
              <button class="code-box-copy__btn btn-clipboard" data-clipboard-target="#example-hea6" title="" data-original-title="Copy">
                <i class="icofont icofont-copy-alt"></i>
              </button>
