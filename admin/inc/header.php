...
<head>
    ...
    <link rel="stylesheet" href="../assets/js/editor/summernote/summernote-lite.css">
        ...
        <div class="page-main-header">
            ...
            <div class="main-header-right">
                ...
                <div class="nav-right col">
                  ...
                  ">
                                <li>
                                    <a href="javascript:void(0)">Profile <?php echo $_SESSION['user_id']; ?><span class="pull-right"><i data-feather="user"></i></span></a>
                                </li>
                                <li>
