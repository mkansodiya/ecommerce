...
<section class="section-big-py-space b-g-light">
    <div class="custom-container">
        <div class="checkout-page contact-page">
            <div class="checkout-form">
                <form action="" class="product_id"></form>
                <form id="checkout">
                    <div class="row">
                            ...
                            <div class="theme-form">
                                <div class="row check-out ">
                                    ...
                                    <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                        ...
                                        <input type="text" name="phone_no" value="" placeholder="">
                                    </div>
                                    <div class="form-group col-md-6 col-sm-6 col-xs-12">
                                    ...
                                    <div class="form-group col-md-12 col-sm-6 col-xs-12">
                                        ...
                                        <input type="text" name="pin_code" value="" placeholder="">
                                    </div>
                                    <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <input type="checkbox" name="account_option" id="account-option"> &ensp;
                            ...
                            <div class="checkout-details theme-form  section-big-mt-space">
                                <div class="order-box">
                                    ...
                                    <ul class="qty">
                                        ...
                                        ?>
                                            <li class="product_name"><?php echo $p['product_name'] . "×" . $qty . "<span>$total</span>"; ?> </li>

                                        <?php } ?>
                                    </ul>
                                    <ul class="sub-total">
                                        <li>Subtotal <span class="count"><?php echo $t; ?></span></li>
                                        <li>Shipping
                                            <div class="shipping">
                                    ...
                                    <ul class="total">
                                        <li>Total <span class="count" id="total_amount"><?php echo $t; ?></span></li>
                                    </ul>
                                </div>
                                            ...
                                            <ul>
                                                <li>
                                                    <div class="radio-option">
                                                        <input class="payment-group" type="radio" value="check" name="payment-group" id="payment-1" checked="checked">
                                                ...
                                                <li>
                                                    <div class="radio-option">
                                                        <input class="payment-group" type="radio" value="COD" name="payment-group" id="payment-2">
                                                ...
                                                <li>
                                                    <div class="radio-option paypal">
                                                        <input class="payment-group" type="radio" value="razorpay" name="payment-group" id="payment-3">
                                                        <label for="payment-3">Razorpay</label>
                                                    </div>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="text-right"><a onclick="cartCalc();" href="javascript:void(0)" class="btn-normal btn">Place Order</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        function cartCalc() {
            $.ajax({
                url: "admin/inc/ajax/cart_total.php",
                type: "POST",
                data: '',
                contentType: false,
                processData: false,
