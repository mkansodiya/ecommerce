...
if (isset($_GET['order_id'])) {
    ...
    $name = mysqli_fetch_assoc(getOrder($order_id))['payment_status'] . " " . mysqli_fetch_assoc(getOrder($order_id))['payment_status'];
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="success-text"><i class="fa fa-check-circle" aria-hidden="true"></i>
                    <h2>thank you</h2>
                    <p>Payment is successfully processsed and your order is <?php echo mysqli_fetch_assoc(getOrder($order_id))['order_status'];; ?></p>
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="product-order">
                    ...
                    <?php while ($order_data = mysqli_fetch_assoc($order_q)) {
                        $product_name = mysqli_fetch_assoc(getProductByID($order_data['product_id']))['product_name'];
                    ...
                    ?>
                        <div class="row product-order-detail">
                            ...
                            <div class="col-3 order_detail">
                                <div>
                                    <h4>quantity</h4>
                                    <h5><?php echo $order_data['product_qty']; ?></h5>
                                </div>
                            </div>
                            <div class="col-3 order_detail">
                                <div>
                                    <h4>price</h4>
                                    <h5><?php echo ($order_data['price']) * ($order_data['product_qty']); ?></h5>
                                </div>
                            </div>
                        </div>
                    <?php } ?>
                    ...
                    <div class="total-sec">
                        <ul>
                            <li>subtotal <span><?php echo  $order_total; ?></span></li>
                            <li>shipping <span>0</span></li>
                            <li>tax(GST) <span>0</span></li>
                        </ul>
                    </div>
                    <div class="final-total">
                        <h3>total <span><?php echo  $order_total; ?></span></h3>
                    </div>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="row order-success-sec">
                    <div class="col-sm-6">
                        ...
                        <ul class="order-detail">
                            ...
                            <li>Order Total: <?php echo  $order_total; ?></li>
                        </ul>
                    </div>
                    <div class="col-sm-6">
                        ...
                        <ul class="order-detail">
                            ...
                            <li><?php echo  $country . "," . $pin_code; ?></li>
                            <li>Contact No. <?php echo  $phone_no; ?></li>
                        </ul>
                    </div>
...
<?php
if ($payment_method == "razorpay" && $payment_status == 0) {
    header("location: razorpay/pay.php?order_id=$order_id");
}
?>
