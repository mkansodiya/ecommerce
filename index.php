...
$cats = getCategories();
$cat_data = array();
while ($c_data = mysqli_fetch_assoc($cats)) {
  $cat_data[] = $c_data;
}
...
<section class="brand-panel">
  <p class="page_title" style="display: none;">Ecommerce Home </p>
  <div class="brand-panel-box">
    <div class="brand-panel-contain ">
      <ul>
        <li><a href="javascript:void(0)">top brand</a></li>
        <li><a>:</a></li>
        <li><a href="category-page(left-sidebar).php">aerie</a></li>
        <li><a href="category-page(left-sidebar).php">baci lingrie</a></li>
        <li><a href="category-page(left-sidebar).php">gerbe</a></li>
        <li><a href="category-page(left-sidebar).php">jolidon</a></li>
        <li><a href="category-page(left-sidebar).php">Wonderbra</a></li>
        <li><a href="category-page(left-sidebar).php">Ultimo</a></li>
        <li><a href="category-page(left-sidebar).php">Vassarette </a></li>
        <li><a href="category-page(left-sidebar).php">Oysho</a></li>
      </ul>
    </div>
  </div>
</section>
            ...
            <div class="slider-banner p-center slide-banner-1">
              ...
              <div class="slider-banner-contain">
                <div>
                  ...
                  <a href="<?php echo  "product.php?id=" . $product_data["product_id"]; ?>" class="btn btn-normal">
                    Shop Now
                  </a>
                </div>
              </div>
                    ...
                    <div class="product-box">
                      <div class="product-imgbox">
                        <div class="product-front">
                          <a href="<?php echo  "product.php?id=" . $product_data["product_id"]; ?>">
                            <img src=" <?php echo  "assets/images/products/" . $product_data["product_image"]; ?>" class="img-fluid  " alt="product">
                          </a>
                        </div>
                        ...
                        <div class="product-icon icon-inline">
                          <button onclick="manageCart(<?php echo  $product_data['product_id']; ?>,1,'add')" class="tooltip-top" data-tippy-content="Add to cart">
                            <i data-feather="shopping-cart"></i>
                          </button>
                          <a href="javascript:void(0)" class="add-to-wish tooltip-top" data-tippy-content="Add to Wishlist">
                            <i data-feather="heart"></i>
                          </a>
                          <a onclick="getProduct(<?php echo $product_data['product_id'] ?>,4,'editCart');" href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#quick-view" class="tooltip-top" data-tippy-content="Quick View">
                        ...
                        <div class="detail-title">
                          ...
                          <div class="detail-right">
                            <div class="check-price">
                              <?php echo $currency . $product_data["mrp"]; ?>
                            </div>
                            <div class="price">
                              <div class="price">
                                <?php echo $currency . $product_data["selling_price"]; ?>
                              </div>
                            </div>
                          </div>
                        </div>
        ...
        <div class="collection-banner-main banner-5 p-center">
          ...
          <div class="collection-banner-contain ">
            <div class="sub-contain">
              ...
              <div class="shop">
                <a class="btn btn-normal" href="<?php echo  "product.php?id=" . $product_data["product_id"]; ?>">
                  shop now
                </a>
              </div>
            </div>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-12 col-lg-4 ">
        <div class="deal-banner-containe">
          <diV class="deal-btn">
            <a href="category-page(left-sidebar).php" class="btn-white">
              View more
            </a>
          </div>
        </div>
            ...
            <div>
              <div class="category-contain">
                <div class="img-wrapper">
                  <a href="category-page(left-sidebar).php">
                    <img src="<?php echo  "assets/images/products/" . $product_data["product_image"]; ?>" alt="category  " class="img-fluid">
                  </a>
                </div>
                <a href="category-page(left-sidebar).php" class="btn-rounded">
                  ...
                  <div class="media-banner media-banner-1 border-0">
                    ...
                    ?>
                      ...
                      <div class="media-banner-box">
                        <div class="media">
                          <a href="<?php echo  "product.php?id=" . $product_data["product_id"]; ?>">
                            <img src="<?php echo  "assets/images/products/" . $product_data["product_image"]; ?>" class="img-fluid " alt="banner">
                          </a>
                            ...
                            <div class="media-contant">
                              <div>
                                <div class="product-detail">
                                  ...
                                  <h6><?php echo $currency . $product_data["mrp"]; ?> <span><?php echo $currency . $product_data["selling_price"]; ?></span></h6>
                                </div>
                                <div class="cart-info">
                                  <button onclick="manageCart(<?php echo  $product_data['product_id']; ?>,1,'add')" class="tooltip-top" data-tippy-content="Add to cart"><i data-feather="shopping-cart"></i></button>
                                  <a href="javascript:void(0)" class="add-to-wish tooltip-top" data-tippy-content="Add to Wishlist"><i data-feather="heart"></i></a>
                                  <a href="javascript:void(0)" onclick="getProduct(<?php echo $product_data['product_id'] ?>,4,'editCart');" data-bs-toggle="modal" data-bs-target="#quick-view" class="tooltip-top" data-tippy-content="Quick View"><i data-feather="eye"></i></a>
              ...
              <div class="row hot-deal-subcontain hotdeal-block1">
                    ...
                    ?>
                      <a href="<?php echo  "product.php?id=" . $product_data["product_id"]; ?>">
                        <div class="img-wrraper">
                          <div>
                            <img src="<?php echo  "assets/images/products/" . $product_data["product_image"]; ?>" alt="hot-deal" class="img-fluid  bg-img">
                          </div>
                        </div>
                      </a>
                    <?php } ?>
                  ...
                  <div class="hotdeal-right-slick border-0">
                    ...
                    ?>
                      <div>
                        <div>
                          <a href="<?php echo  "product.php?id=" . $product_data["product_id"]; ?>">
                            <h5><?php echo $product_data['product_name'] ?></h5>
                          </a>
                          <ul class="rating">
                            <li><i class="fa fa-star"></i></li>
                            <li><i class="fa fa-star"></i></li>
                          ...
                          <h6> <?php echo $currency . $product_data['selling_price'] ?> <span><?php echo $currency . $product_data['mrp'] ?></span></h6>
                          <div class="timer">
                            <p id="demo">
                            </p>
                          </div>
                          <a href="<?php echo  "product.php?id=" . $product_data["product_id"]; ?>" class="btn btn-normal btn-md ">shop now</a>
                        </div>
                      </div>
                ...
                <div class="col-md-2 ">
                  <div class="hotdeal-right-nav">
                    ...
                    ?>
                      <div><img src="<?php echo  "assets/images/products/" . $product_data["product_image"]; ?>" alt="hot-dea" class="img-fluid  "></div>
                    <?php } ?>
                  </div>
                </div>
              </div>
              ...
              <div class="product-box">
                <div class="product-imgbox">
                  ...
                  <div class="product-icon icon-inline">
                    ...
                    <a href="javascript:void(0)" onclick="getProduct(<?php echo $product_data['product_id'] ?>,4,'editCart');" data-bs-toggle="modal" data-bs-target="#quick-view" class="tooltip-top" data-tippy-content="Quick View">
                      <i data-feather="eye"></i>
                    </a>
                    <a href="compare.php" class="tooltip-top" data-tippy-content="Compare">
                      <i data-feather="refresh-cw"></i>
...
<!-- Add to cart bar -->
<?php include("inc/cart_slide.php"); ?>
<!-- Add to cart bar end-->
...
<!-- notification product -->
<?php include("inc/footer_src.php"); ?>